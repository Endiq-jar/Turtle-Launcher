...
import static net.endiq.launcher.MainActivity.touchCharInput;
...
import net.endiq.launcher.customcontrols.gamepad.DefaultDataProvider;
import net.endiq.launcher.customcontrols.gamepad.Gamepad;
import net.endiq.launcher.customcontrols.mouse.AbstractTouchpad;
import net.endiq.launcher.customcontrols.mouse.AndroidPointerCapture;
import net.endiq.launcher.customcontrols.mouse.InGUIEventProcessor;
