package net.endiq.launcher.customcontrols.buttons;

import static net.endiq.launcher.customcontrols.gamepad.GamepadJoystick.DIRECTION_EAST;
import static net.endiq.launcher.customcontrols.gamepad.GamepadJoystick.DIRECTION_NONE;
import static net.endiq.launcher.customcontrols.gamepad.GamepadJoystick.DIRECTION_NORTH;
import static net.endiq.launcher.customcontrols.gamepad.GamepadJoystick.DIRECTION_NORTH_EAST;
import static net.endiq.launcher.customcontrols.gamepad.GamepadJoystick.DIRECTION_NORTH_WEST;
import static net.endiq.launcher.customcontrols.gamepad.GamepadJoystick.DIRECTION_SOUTH;
import static net.endiq.launcher.customcontrols.gamepad.GamepadJoystick.DIRECTION_SOUTH_EAST;
import static net.endiq.launcher.customcontrols.gamepad.GamepadJoystick.DIRECTION_SOUTH_WEST;
import static net.endiq.launcher.customcontrols.gamepad.GamepadJoystick.DIRECTION_WEST;
...
import net.endiq.launcher.customcontrols.gamepad.GamepadJoystick;
import net.endiq.launcher.customcontrols.handleview.EditControlPopup;
