package kr.co.donghyun.turtlelauncher.data.update
...
object GithubUpdateChecker {
    ...
    private val userAgent = "Endiq-jar/TurtleLauncher/${BuildConfig.VERSION_NAME} (kr.co.donghyun.turtlelauncher)"
    ...
    suspend fun fetchUpdate(currentVersion: String): GithubRelease? = withContext(Dispatchers.IO) {
        try {
            ...
            Log.w("TURTLE_LAUNCHER", "업데이트 확인 실패: ${e.message}")
            null
        }
    }
