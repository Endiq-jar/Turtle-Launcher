package kr.co.donghyun.turtlelauncher.presentation.util.fabric
        ...
        return try {
            ...
            libs.forEachIndexed { i, el ->
                ...
                if (!destFile.exists() || destFile.length() == 0L) {
                    ...
                    if (!ok) {
                        Log.w("TURTLE_LAUNCHER", "Fabric 라이브러리 실패: $name")
                    }
                }
            ...
            Log.d("TURTLE_LAUNCHER", "✅ Fabric 설치: mainClass=$mainClass, jars=${jarList.size}, jvmArgs=$gameJvmArgs")
            ...
            Log.e("TURTLE_LAUNCHER", "Fabric 설치 예외", e)
