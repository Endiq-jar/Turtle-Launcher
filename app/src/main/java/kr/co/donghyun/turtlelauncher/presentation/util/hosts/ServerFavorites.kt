package kr.co.donghyun.turtlelauncher.presentation.util.hosts
...
object ServerFavorites {
    ...
    fun list(context: Context, instanceId: String): List<Favorite> {
        ...
        return try {
            ...
            Log.w("TURTLE_LAUNCHER", "즐겨찾기 로드 실패: ${e.message}")
            emptyList()
        }
    }
    ...
    private fun save(context: Context, instanceId: String, favs: List<Favorite>) {
        try {
            ...
            Log.w("TURTLE_LAUNCHER", "즐겨찾기 저장 실패: ${e.message}")
        }
    }
    ...
    fun add(context: Context, instanceId: String, mcVersion: String, name: String, address: String): Boolean {
        ...
        return try {
            ...
            Log.w("TURTLE_LAUNCHER", "servers.dat 주입 실패: ${e.message}")
            false
        }
    }
    ...
    fun remove(context: Context, instanceId: String, mcVersion: String, address: String) {
        ...
        try {
            ...
            Log.w("TURTLE_LAUNCHER", "servers.dat 제거 실패: ${e.message}")
        }
    }
    ...
    fun syncToServersDat(context: Context, instanceId: String, mcVersion: String) {
        ...
        try {
            ...
            Log.d("TURTLE_LAUNCHER", "즐겨찾기 ${favs.size}개를 servers.dat 에 동기화")
        } catch (e: Exception) {
            Log.w("TURTLE_LAUNCHER", "servers.dat 동기화 실패: ${e.message}")
        }
    }
}