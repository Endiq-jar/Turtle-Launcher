 ...
 *  - 패키지: kr.co.donghyun.turtlelauncher.presentation.util.terracota (실제 디렉터리 기준)
...
package kr.co.donghyun.turtlelauncher.presentation.util.terracota;
...
public class TerracottaVPNService extends VpnService {
    ...
    public static final String CHANNEL_ID = "turtle_terracotta_vpn";

    public static final String ACTION_START        = "kr.co.donghyun.turtlelauncher.terracotta.action.START";
    public static final String ACTION_STOP         = "kr.co.donghyun.turtlelauncher.terracotta.action.STOP";
    public static final String ACTION_REPOST       = "kr.co.donghyun.turtlelauncher.terracotta.action.REPOST";
    public static final String ACTION_UPDATE_STATE = "kr.co.donghyun.turtlelauncher.terracotta.action.UPDATE_STATE";
