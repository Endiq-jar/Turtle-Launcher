...
val Flame = Color(0xFFC7E8B0)      // 포인트 컬러 (블루 플레임)
...
internal val FlamePrimary   = Color(0xFFC7E8B0)   // 메인 플레임 (핫 블루)
internal val FlameLight     = Color(0xFFC7E8B0)   // 라이트 플레임
internal val FlameDark      = Color(0xFF9CCF93)   // 다크 플레임 (딥 블루)
internal val FlameAccent    = Color(0xFF9CCF93)   // 액센트 (시안 — 불꽃 심지)
