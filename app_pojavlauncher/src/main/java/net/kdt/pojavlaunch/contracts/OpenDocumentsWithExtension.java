...
// Turtle Launcher API: multi-selection variant of OpenDocumentWithExtension.
// Upstream Amethyst ships a single-Uri contract under that name; this class keeps
// the old Turtle signature (List<Uri> + allowMultiple) for the Turtle UI layer.
public class OpenDocumentsWithExtension extends ActivityResultContract<Object, List<Uri>> {
    private final String mimeType;
    private final boolean allowMultiple;

    public OpenDocumentsWithExtension(String extension) {
        this(extension, false);
    }

    /**
     * Create a new OpenDocumentsWithExtension contract.
     ...
     */
    public OpenDocumentsWithExtension(String extension, boolean allowMultiple) {
