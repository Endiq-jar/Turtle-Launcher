...
/**
 * Category collection for both CurseForge and Modrinth; records the real value behind each
 * category so resource searches can fill it in.
 * A null curseforge/modrinth id means the category does not exist on that platform.
 */
enum class Category(val classify: Classify, val resNameID: Int, val curseforgeID: String?, val modrinthName: String?) {
    ...
    // Mod and modpack data source: https://github.com/Hex-Dragon/PCL2/blob/f40a2990103ae85c34acb5d8d367ab1644aa7ca6/Plain%20Craft%20Launcher%202/Modules/Minecraft/ModComp.vb#L281
    // Thanks to Longteng Maoyue!!!!
    // Mod category.
