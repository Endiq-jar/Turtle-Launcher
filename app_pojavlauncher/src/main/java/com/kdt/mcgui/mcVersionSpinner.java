 ...
 *
 * Ported from the Amethyst stack for the landscape launcher layout. The
 * profile-editor fragments it used to link to were not carried over to the
 * Turtle UI, so this spinner acts purely as a profile switcher.
 */
public class mcVersionSpinner extends ExtendedTextView {
    /** Marker value posted via ExtraCore when the selected profile was deleted. */
    private static final String DELETED_PROFILE = "deleted_profile";
